...
#define LOGE(msg) __android_log_print(ANDROID_LOG_ERROR, LOG_TAG, "__file__ -> " msg)
#define LOGI(msg) __android_log_print(ANDROID_LOG_INFO, LOG_TAG, "__file__ -> " msg)
#define LOGD(msg) __android_log_print(ANDROID_LOG_DEBUG, LOG_TAG, "__file__ -> " msg)
